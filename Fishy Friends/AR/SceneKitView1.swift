...
struct SceneKitView1: UIViewRepresentable {
    ...
    let gifNames = ["Angler Fish", "Angler eat", "Lantern Sleep", "Angler Sick"]
...
//        }
    ...
    class Coordinator: NSObject {
        var parent: SceneKitView1
        var isSleep = false

        init(_ parent: SceneKitView1) {
            self.parent = parent
        }
...
//struct SceneKitView11: UIViewRepresentable {
